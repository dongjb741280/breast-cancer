...
- **BRCA1/2 突变**：有突变 / 无突变 / 未检测（原文常写「BRCA1/2 突变」「gBRCA」「胚系 BRCA」）。决定含铂方案（三阴新辅助）、奥拉帕利（辅助强化）、PARP 抑制剂（晚期三阴）。
- **绝经状态**：绝经前 / 绝经后 / 未记录。判据：年龄≥60、双侧卵巢切除、自然停经≥12 月（近 1 年无化疗/TAM/托瑞米芬/去势）等。决定 HR+ 内分泌（绝经前 OFS+AI vs 绝经后 AI+CDK4/6i）。
- **PD-L1 CPS**：CPS 评分（原文常写「CPS≥10」「PD-L1 阳性 CPS≥1」），未测给「未检测」。决定三阴新辅助免疫、晚期三阴免疫。
- **转移部位**：只在「X 继发恶性肿瘤 / X 转移 / 转移瘤 / 转移灶」语境下命中（肝/骨/脑/肺/肾上腺/胸膜），避免把体检正常描述误当转移。**脑转移再分脑实质 vs 脑膜**（原文「脑膜转移」「软脑膜」「鞘内」→ 脑膜）。
...
- **未提供 ≠ 阴性**：病历没写受体/分期/病理反应/BRCA/绝经/CPS，就写「未记录/待补充」，不能默认判为阴性或正常。
- **混淆双侧/多病灶受体**：双侧乳腺或原发灶 vs 转移灶受体不一致时，分别说明（如「右侧 HER2+、左侧 FISH 未扩增」），以驱动治疗的主导病灶为准。
- **M 分期可疑未确诊**：疑似转移但无活检/PET 确认 → 在 D 标「M 分期待核实」，停。
- **脑膜转移**：走到 R 时区分脑实质 vs 脑膜——脑膜转移走全中枢放疗/鞘内注射，需转 CNS MDT；活动性脑实质转移也先局部处理，而非直接全身序贯。
